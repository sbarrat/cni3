<?
/*
 * FIXME:Renombrar fichero y limpiar
 */
...
function actualiza_categoria($vars)
{
	...
	//else
		...
		//else //actualizacion
			//$sql = "Insert into `$tabla` (`Nombre`,`Descripción`) values ('$vars[Nombre]','$vars[Descripcion]')";
	if(TRUE == ($consulta = mysql_db_query($dbname,$sql,$con)))
		$cadena = "todo ok";
	else
